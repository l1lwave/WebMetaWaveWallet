...
<head>
    ...
    <link rel="stylesheet" href="/style/SendWindow.css">
</head>
<body>
<div class="container">
    <div class="head">
    ...
    <form action="/send" method="get">
        <div class="main-info-container">
            <div class="container-info">
                ...
                <input type="text" class="wallet-number-input" name="walletNumber" placeholder="">
            </div>

            <div class="container-info-seccond">
                <h2 class="text-value-seccond">
                    Network
                </h2>
                <details class="dropdown">
                    <summary class="dropdown-btn">${LabelNetworkName}<span class="arrow">▼</span></summary>
                    <ul class="dropdown-menu">
                        <c:forEach items="${networks}" var="network">
                            <li><a href="/sendToken/network=${network.id}/token=${selectedTokenId}">${network.name}</a></li>
                        </c:forEach>
                    </ul>
                </details>
                <h2 class="text-value-seccond">
                ...
                <details class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <c:forEach items="${tokens}" var="token">
                            <li><a href="/sendToken/network=${selectedNetworkId}/token=${token.id}">${token.tokenName}</a></li>
                        </c:forEach>
                    </ul>
                </details>
                ...
                <input type="hidden" id="gas" name="gas" value="${sendGas}">
        ...
        <button class="button-func" type="submit">
            <img class="button-icon" src="/images/icons/mingcute_send-line.svg" alt="send">
            Send
        </button>
