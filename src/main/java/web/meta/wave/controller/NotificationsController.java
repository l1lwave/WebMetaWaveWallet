...
public class NotificationsController {
    ...
    @GetMapping("/editNotification/{notificationId}")
    public String showEditForm(@PathVariable("notificationId") Long id, Model model) {
        Optional<Notifications> notification = notificationsService.findNotificationsById(id);

        if (notification.isPresent()) {
            model.addAttribute("notification", notification.get());
            return "editNotificationWindow";
        } else {
    ...
    public String updateNotification(@ModelAttribute("notification") Notifications notification) {
        notificationsService.saveNotifications(notification);
