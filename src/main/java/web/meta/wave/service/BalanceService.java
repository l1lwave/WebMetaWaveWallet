...
public class BalanceService {
    ...
    @Transactional
    public boolean addBalance(Network network, MetaToken token, CustomUser user, BigDecimal amount) {
    ...
    @Transactional
    public boolean updateBalance(Network network, MetaToken token, CustomUser user, BigDecimal amount) {
